      ...
      >
        ...
        >
          ...
          <div className="flex shrink-0 sticky top-0 z-30 items-center justify-between border-b border-border/30 bg-surface px-3 sm:px-4 py-2.5 sm:py-3">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center rounded-lg border border-border/40 bg-elevated/40 p-0.5">
                <button
                  type="button"
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border/40 bg-elevated/40 text-textMuted transition-colors hover:bg-elevated hover:text-textPrimary"
              >
              ...
              <button
                ...
                onClick={onClose}
                title="Close Modal"
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border/40 bg-elevated/40 text-textMuted transition-colors hover:bg-red-500/20 hover:text-red-400"
              >
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
