...
import { signupAccount, googleLoginAccount, clearChatCache } from "../api/api";
    ...
    <div className={`w-full ${isModal ? "" : "max-w-[420px]"}`}>
      ...
      >
        ...
        <div className="mt-8 border-t border-border/20 pt-8">
            <p className="text-center text-[10px] font-semibold uppercase tracking-widest text-textMuted mb-4">
